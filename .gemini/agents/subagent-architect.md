...
The Main Agent uses the `description` field to decide _who_ to call.

- _Bad:_ "Helps with git."
- _Good:_ "Git expert agent. Use for all local and remote git operations including commits, bisecting regressions, and interacting with GitHub issues."
